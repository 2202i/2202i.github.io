if (!self._FC2COUNTER38931944_1)
{
	var _FC2COUNTER38931944_1 =
	{
		id:38931944,
		graph_img:null,
		show_graph:function(e)
		{
			if (this.graph_img == null )
			{
				...
				img.src = 'https://counter1-cdn-ssl.fc2.com/popup.php?id=38931944&main=1&lang=0';
		...
		disp_js:function()
		{
			...
			document.write('<script type="text/javascript" language="javascript"'
				+ ' src="https://counter1.fc2.com/counter_js.php?id=38931944&main=1&lang=0'
				+ '&amp;visitor=' + this.visit_info()
				+ '" charset="UTF-8"></'+'script>');
			}else{
			const script = document.createElement('script');
			script.src = "https://counter1.fc2.com/counter_js.php?id=38931944&main=1&lang=0&visitor=" + this.visit_info();
